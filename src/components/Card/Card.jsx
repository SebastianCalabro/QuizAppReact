        ...
        <div className={s.box}>
            ...
            <svg className={s.shadow} xmlns="http://www.w3.org/2000/svg" width="125" height="52" viewBox="0 0 125 52" fill="none">
                    <g filter="url(#filter0_f_0_25)">
                        <ellipse cx="62.5" cy="26" rx="40.5" ry="4" fill="#1C1C1C" fillOpacity="0.767068"/>
                    </g>
                    <defs>
                        <filter id="filter0_f_0_25" x="0.253746" y="0.253746" width="124.493" height="51.4925" filterUnits="userSpaceOnUse" colorInterpolationFilters="sRGB">
